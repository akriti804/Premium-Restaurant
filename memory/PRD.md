...
- **2026-05-29 (v4)**: New **Food Showcase** section with 20 AI-generated photoreal premium food images. Hero signature rotates daily. Rating bumped to **4.6★**. New "Showcase" nav link. (100% pass — iteration_3.json)
- **2026-05-29 (v5)**: Replaced contact phone with **+91 612 222 4804** (tel:+916122224804 / WhatsApp 916122224804) across Contact, Footer, and Restaurant Identity. Removed email row from Footer. Added the real **Bansi Vihar storefront photograph** (Boring Road, Patna) prominently in (a) Story section right card with luxury dark gradient + gold border, and (b) a new full-width **Restaurant Identity** banner section (`#visit`) between Reviews and Contact with cinematic vignette, brand name, address, hours, and Call/WhatsApp CTAs.
